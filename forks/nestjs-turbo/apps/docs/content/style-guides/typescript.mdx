...
> An unofficial TypeScript Style Guide - Source: [Typescript Book - Style Guide](https://github.com/basarat/typescript-book/blob/master/docs/styleguide/styleguide.md)
