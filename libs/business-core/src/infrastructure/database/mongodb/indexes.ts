...
export const USER_INDEXES = {
  ...
  /** 组织+用户状态索引 */
  ORGANIZATION_STATUS: { platformId: 1, tenantId: 1, organizationId: 1, status: 1 },
  
  /** 部门+用户状态索引 */
  DEPARTMENT_STATUS: { platformId: 1, tenantId: 1, organizationId: 1, departmentId: 1, status: 1 },
...
export const USER_ROLE_INDEXES = {
  ...
  /** 组织+用户角色索引 */
  ORGANIZATION_USER: { platformId: 1, tenantId: 1, organizationId: 1, userId: 1 },
  
  /** 部门+用户角色索引 */
  DEPARTMENT_USER: { platformId: 1, tenantId: 1, organizationId: 1, departmentId: 1, userId: 1 },
