...
export class UpdateUserCommandHandler
  implements ICommandHandler<UpdateUserCommand, UpdateUserResponse>
{
  constructor(
...
export class ActivateUserCommandHandler
  implements ICommandHandler<ActivateUserCommand, ActivateUserResponse>
{
  constructor(
...
export class DeactivateUserCommandHandler
  implements ICommandHandler<DeactivateUserCommand, DeactivateUserResponse>
{
  constructor(
