...
const SAAS_CORE_PATH = join(__dirname, "..", "libs", "saas-core", "src");
...
async function fixImportsInFile(filePath) {
  ...
  if (hasChanges) {
    ...
    console.log(`✅ Fixed imports in: ${relative(SAAS_CORE_PATH, filePath)}`);
    return true;
  }
 ...
 */
async function main() {
  console.log("🚀 开始修复 saas-core 中的相对导入路径...");

  try {
    const files = await getAllTsFiles(SAAS_CORE_PATH);
