...
# 1. 修复 cacheService.keys() - 这个方法不存在，需要替换
find /home/arligle/hl8/hl8-saas-platform-turborepo/libs/messaging/src -name "*.ts" -exec sed -i 's|await this\.cacheService\.keys(|await this.getAllKeys(|g' {} \;

# 2. 修复 cacheService.delete() - 改为 cacheService.del()
find /home/arligle/hl8/hl8-saas-platform-turborepo/libs/messaging/src -name "*.ts" -exec sed -i 's|this\.cacheService\.delete(|this.cacheService.del(|g' {} \;
