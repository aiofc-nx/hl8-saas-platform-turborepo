...
│   │   │   ├── handlers/
│   │   │   │   ├── command-handlers/
│   │   │   │   │   ├── platform-command-handlers.ts
│   │   │   │   │   ├── tenant-command-handlers.ts
│   │   │   │   │   ├── organization-command-handlers.ts
│   │   │   │   │   ├── department-command-handlers.ts
│   │   │   │   │   ├── user-command-handlers.ts
│   │   │   │   │   ├── authentication-command-handlers.ts
│   │   │   │   │   ├── session-command-handlers.ts
│   │   │   │   │   ├── permission-command-handlers.ts
│   │   │   │   │   ├── role-command-handlers.ts
│   │   │   │   │   └── *.spec.ts
│   │   │   │   ├── query-handlers/
│   │   │   │   │   ├── platform-query-handlers.ts
│   │   │   │   │   ├── tenant-query-handlers.ts
│   │   │   │   │   ├── organization-query-handlers.ts
│   │   │   │   │   ├── department-query-handlers.ts
│   │   │   │   │   ├── user-query-handlers.ts
│   │   │   │   │   ├── authentication-query-handlers.ts
│   │   │   │   │   ├── session-query-handlers.ts
│   │   │   │   │   ├── permission-query-handlers.ts
│   │   │   │   │   ├── role-query-handlers.ts
│   │   │   │   │   └── *.spec.ts
│   │   │   │   ├── event-handlers/
│   │   │   │   │   ├── platform-event-handlers.ts
│   │   │   │   │   ├── tenant-event-handlers.ts
│   │   │   │   │   ├── organization-event-handlers.ts
│   │   │   │   │   ├── department-event-handlers.ts
│   │   │   │   │   ├── user-event-handlers.ts
│   │   │   │   │   ├── authentication-event-handlers.ts
│   │   │   │   │   ├── session-event-handlers.ts
│   │   │   │   │   ├── permission-event-handlers.ts
│   │   │   │   │   ├── role-event-handlers.ts
│   │   │   │   │   └── *.spec.ts
│   │   │   │   └── *.spec.ts
│   │   │   ├── projectors/
│   │   │   │   ├── platform-projectors.ts
│   │   │   │   ├── tenant-projectors.ts
│   │   │   │   ├── organization-projectors.ts
│   │   │   │   ├── department-projectors.ts
│   │   │   │   ├── user-projectors.ts
│   │   │   │   ├── authentication-projectors.ts
│   │   │   │   ├── session-projectors.ts
│   │   │   │   ├── permission-projectors.ts
│   │   │   │   ├── role-projectors.ts
│   │   │   │   └── *.spec.ts
│   │   │   ├── sagas/
│   │   │   │   ├── platform-sagas.ts
│   │   │   │   ├── tenant-sagas.ts
│   │   │   │   ├── organization-sagas.ts
│   │   │   │   ├── department-sagas.ts
│   │   │   │   ├── user-sagas.ts
│   │   │   │   ├── authentication-sagas.ts
│   │   │   │   ├── session-sagas.ts
│   │   │   │   ├── permission-sagas.ts
│   │   │   │   ├── role-sagas.ts
│   │   │   │   └── *.spec.ts
...
**Structure Decision**: 基于现有的libs/business-core架构，扩展领域实体、值对象、聚合根、仓储、服务、事件等核心组件，遵循Clean Architecture分层原则，支持多租户数据隔离和事件驱动架构。新增CQRS命令查询分离、事件溯源、事件驱动架构的完整实现结构。
